...
contract AuctionManager is KeeperCompatibleInterface {
    ...
    event AuctionCreated(uint256 auctionId, address seller, address nftAddress, uint256 tokenId, uint256 startTime, uint256 endTime);
     ...
     */
    function verifyFinalAuctionZkProof(
        uint256 auctionId,
        uint256 winningBidIndex,
        bytes memory finalZkProof
    ...
    function placeBid(
        ...
        bytes calldata individualZkProof
